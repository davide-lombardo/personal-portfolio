...
const Hero = () => {
    return (
        <section className="container flex py-24 md:flex-row flex-col items-center min-w-full text-gray-900">
            ...
            >
                <h1 className="text-5xl md:text-4xl lg:text-5xl mb-4 font-display font-extrabold ">
                    Realizzo soluzioni frontend intuitive e performanti.
                </h1>
                <p className="mb-7 leading-relaxed font-medium">
                    Davide Lombardo - Frontend Developer.
                </p>
